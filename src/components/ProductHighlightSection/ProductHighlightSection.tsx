                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <Link className="product-item" to="/cart">
                            <img src="/images/product-1.png" className="img-fluid product-thumbnail" alt="T-shirt Uniqlo" />
                            <h3 className="product-title">T-shirt Uniqlo</h3>
                    ...
                    <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <Link className="product-item" to="cart.html">
                            ...
                            <h3 className="product-title">T-shirt Zara</h3>
                    ...
                    <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <Link className="product-item" to="cart.html">
                            ...
                            <h3 className="product-title">T-shirt H&M</h3>
